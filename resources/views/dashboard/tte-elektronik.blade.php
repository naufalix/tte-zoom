  ...
  <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
    ...
    <div>
      ...
      <div class="col-12 d-flex">
        <h1 class="anchor fw-bolder mb-5" id="striped-rounded-bordered">Pengajuan TTE</h1>
      </div>
      <!--end::Heading-->
      <hr>
      <!--begin::Block-->
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="mb-5 col-12 col-md-6">
                  ...
                  <input type="text" class="form-control" name="position" required placeholder="Jabatan">
                </div>
                <div class="mb-5 col-12 col-md-6">
