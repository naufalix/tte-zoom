        ...
        <table id="myTable" class="table table-striped table-hover table-rounded border gs-7">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                  <a href="#" class="btn btn-icon btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#edit" onclick="edit({{ $z->id }})"><i class="bi bi-pencil-fill"></i></a>
                  <a href="#" class="btn btn-icon btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#hapus" onclick="hapus({{ $z->id }})"><i class="fa fa-times"></i></a>
                </td>
            </tr>
            @endforeach
          </tbody>
